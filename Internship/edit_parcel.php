...
$sql3="select * from parcel where Product_id='$p_id'";
     ...
     $c_name=$row3['C_name'];
     $phone_num=$row3['Phone_num'];
     $instructions=$row3['Instructions'];
     $cash=$row3['Cash_collection'];
     $product_weight=$row3['Product_weight'];
     //$select_address=$row3['select_address'];
			...
			<div class= "container" id="container" style="margin-top: 3%; margin-left: -5%;">
				...
				<h3> Contact Number <font color= "red" size="5"> * </font></h3> 
						...
						<div class= "option">
							<input
							type= "box"
							class= "box" pattern="[0]{1}[1]{1}[0-9]{9}"
							id="contact_number" value="<?php echo $phone_num; ?>"
				...
				<h3> Product Weight <font color= "red" size="5"> * </font></h3>
						...
						<div class= "option">
							...
							type= "box"
							class= "box"
							id="amount" value="<?php echo $product_weight; ?>"
							name= "amount"
        ...
        <option value="">প্রথমে বিভাগ নির্বাচন করুন</option>
				...
				<h3><br> Cash Collection <font color= "red" size="5"> * </font></h3>
						...
						<div class= "option">
							...
							type= "box"
							class= "box"
							id="payment_amount" value="<?php echo $cash; ?>"
							name= "payment_amount" value=100
...
<h5 >Total Payable Amount    Tk. <span id="total">0.00</span></p>
				...
				<h3> Instructions </h3> 
						...
						<div class= "option">
							...
							/><?php echo $instructions; ?></textarea>
											</div>
					<br>	
